%{
    ...
    NN. Final data set is the whole data set, including Pt/CeO2 and
    Au/CeO2. Data set is saved as "final_withPtAuCeO2.txt".
%}
...
for i = 1: length(data_table.Rate_molsCO_min_molMetal_)
    ...
    CorrectionFactor = 1; % Do not make the temperature adjsutment
